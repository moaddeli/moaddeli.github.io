...
BLOG_AUTHOR = "Hamid"  # (translatable)
BLOG_TITLE = "Hamid R. Moaddeli"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://moaddeli.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://moaddeli.github.io/"
BLOG_EMAIL = "hamidreza.moaddeli@gmail.com"
BLOG_DESCRIPTION = "Personal Web-Site"  # (translatable)
...
# (translatable)
# EXTRA_HEAD_DATA = ""
EXTRA_HEAD_DATA = "<style>body { font-size: 20px; }</style>"  # Default is 14px.

# Google Analytics or whatever else you use. Added to the bottom of <body>
# in the default template (base.tmpl).
# (translatable)
BODY_END = """
<div align="center"> <script src="https://www.w3counter.com/tracker.js?id=110394"></script> </div>
<script>
...
GLOBAL_CONTEXT = {
    ...
    {
        "url": "https://twitter.com/hrmoaddeli",
        "bgcolor": "#55ACEE",
        "color": "#fffff",
    ...
    {
        "url": "https://www.linkedin.com/in/Moaddeli",
        "bgcolor": "#3B5998",
        "color": "#fffff",
